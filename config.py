...
# Cores e Formas das Peças (Tetrominós)
...
# Definições das formas das peças
...
RANKING_START_Y = 255          
RANKING_LINE_HEIGHT = 65    
RANKING_COL_POS = 180         
RANKING_COL_NICK = 250         
RANKING_COL_TEMPO = 460        
RANKING_COL_PONTOS = 590       
